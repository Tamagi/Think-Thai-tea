<?php 
    ...
    if ($email=="") {
        ...
        echo "<script>alert('Message must be filled');
        window.location.href='contact-us.html';</script>";
    }
    else{
          ...
          <td align="center" valign="top">
            <center style="width: 100%;">
              ...
              <div style="display: none; font-size: 1px; line-height:
                ...
                sans-serif;"> Someone just contacted you. Hurry up response him/her.</div>
            ...
            <![endif]-->
                ...
                <hr>
                  <div style="max-width:600px" align="center">
                      <p style="margin:0;font-size:30px;font-family:arial">Think Thai contact-us Form</p>
                      <hr>
                      <br>
                      <p style="margin:0;text-align:left;font-size: 20px;font-weight:bold;">Mr/Mrs.'.$name.' has contacted you.</p>
                      <br>
                      ...
                      <div style="max-width:500px;margin-bottom: 40px;" align="center">
                        ...
                        <br><hr>
                          <p style="margin:0;padding-top: 10px;font-size:
                                    16px;font-family:arial;font-weight:500;text-align: left;float: left;width: 150px;color:#4f4f4f">Message</p>
                          <p style="margin:0;padding-top: 10px;font-size:
                                    16px;font-family:arial;font-weight:500;text-align: left;float: left;width: 350px;color:#4f4f4f">: '.$msg.'</p>
                      </div>
                      <br>
                      <hr style="border: 2px solid lightgrey; margin: 0px 50px 0px 50px;">
                      <br>
